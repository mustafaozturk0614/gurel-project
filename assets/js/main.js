...
function changeBrand2() {
  ...
  let brandText1 = document.getElementById("brandText1");

  let brandText2 = document.getElementById("brandText2");

  let brandLink1 = document.getElementById("brandLi");

  let brandLink2 = document.getElementById("brandLink2");

  brandLink1.innerHTML = `<li class="nav-item dropdown hover">

					<a href="#" id="brandLink1" onclick="changeBrand2()" class="nav-link dropdown-toggle has-icon"

					  data-bs-toggle="dropdown" aria-expanded="false">

					  <i class="fa-solid fa-earth-americas icon"></i>

					  <span id="brandText1" class="text">Gürel Mülk Yönetim</span><img class="image-icon dropdown-icon"
					...
					<ul class="dropdown-menu animate fade-down">
					  ...
					  <li class="nav-item">
						...
						<a href="#" id="brandLink1" class="nav-link" onclick="changeBrand1()">

						  <span id="brandText2" class="text">Gürel Yönetim</span>
  ...
  brand.innerHTML = `<a class="navbar-brand" id="brand" href="/">

	  <!-- <div class="site-title">Site Title</div> -->

	  <img src="assets/images/logo4.png" alt="Shock Theme" class="logo main-logo"

		style="width: 120px; height: auto" />

	  <img src="assets/images/logo4.png" alt="Shock Theme" class="logo sticky-logo"

		style="width: 100px; height: auto" />

	  <img src="assets/images/logo4.png" alt="Shock Theme" class="logo mobile-logo" />

	  <span class="logo-after-text">Gürel Mülk Yönetimi</span>
...
function changeBrand1() {
  ...
  brandLink1.innerHTML = `<li class="nav-item dropdown hover">
					...
					<a href="#" id="brandLink1" onclick="changeBrand1()" class="nav-link dropdown-toggle has-icon"

					  data-bs-toggle="dropdown" aria-expanded="false">

					  <i class="fa-solid fa-earth-americas icon">

						</i>

					  <span id="brandText1" class="text">Gürel  Yönetim</span><img class="image-icon dropdown-icon"
					...
					<ul class="dropdown-menu animate fade-down">
					  ...
					  <li class="nav-item">
						...
						<a href="#" id="brandLink1" class="nav-link" onclick="changeBrand2()">

						  <span id="brandText2" class="text">Gürel Mülk Yönetim</span>
  ...
  brand.innerHTML = `<a class="navbar-brand" id="brand" href="/">
		  ...
		  <img src="assets/images/logo1.jpeg" alt="Shock Theme" class="logo main-logo"

			style="width: 120px; height: auto" />

		  <img src="assets/images/logo4.jpeg" alt="Shock Theme" class="logo sticky-logo"

			style="width: 100px; height: auto" />

		  <img src="assets/images/logo4.jpeg" alt="Shock Theme" class="logo mobile-logo" />

		  <span class="logo-after-text">Gürel  Yönetimi</span>
